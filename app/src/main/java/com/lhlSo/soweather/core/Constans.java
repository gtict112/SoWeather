...
//        }
     ...
     */
    enum WeatherBgImg {
        晴("晴", new int[]{R.mipmap.sunny, R.mipmap.sunny2, R.mipmap.hot}),
        热("热", new int[]{R.mipmap.hot}),
        多云("多云", new int[]{R.mipmap.cloudy3, R.mipmap.cloudy5, R.mipmap.cloudy6, R.mipmap.cloudy7}),
        少云("少云", new int[]{R.mipmap.wind}),
        晴间多云("晴间多云", new int[]{R.mipmap.wind2}),
        ...
        小雨("小雨", new int[]{R.mipmap.rain1, R.mipmap.rain3}),
        毛毛雨("毛毛雨", new int[]{R.mipmap.rain1, R.mipmap.rain3}),
        细雨("细雨", new int[]{R.mipmap.rain1, R.mipmap.rain3}),
        冻雨("冻雨", new int[]{R.mipmap.rain1, R.mipmap.rain3}),
        阵雨("阵雨", new int[]{R.mipmap.rain1, R.mipmap.rain3}),
        强阵雨("强阵雨", new int[]{R.mipmap.rain6, R.mipmap.rain5}),
        极端降雨("极端降雨", new int[]{R.mipmap.rain6, R.mipmap.rain5}),
