...
public class InstrumentView extends View {
    private String color_outcircle = "#CC0000";
    private String color_bg_outcircle = "#FF9900";
    private String color_bg_incircle = "#FF6600";
    private String color_progress = "#00CC00";
    private String color_smart_circle = "#CC0000";
    private String color_indicator_left = "#003399";
    private String color_indicator_right = "#003399";
    ...
    private void drawCurrentProgressTv(int progress, Canvas canvas) {
        ...
        canvas.drawText("当前空气质量指数", centerPoint[0], baseLine1, mPaint);
        Paint mPaint1 = new Paint();
        float baseLine2 = outCircleRadius / 20f * 11 - 3 * (fontMetrics.bottom + fontMetrics.top) + centerPoint[1];
        canvas.drawText(String.valueOf(progress), centerPoint[0], baseLine2, mPaint);
    }
    ...
    private void drawPointer(Canvas canvas) {
        ...
        int angle = (int) ((allAngle) / (500 * 1f) * progress) + startAngle;
        //指针的定点坐标
        ...
        canvas.drawArc(rectF, angle - 180, 500, true, mPaint);
        ...
        canvas.drawArc(rectF, angle + 80, 500, true, mPaint);
