...
//        }
    ...
    enum WeatherBgImg {
        ...
        小雨("小雨", new int[]{R.mipmap.rain, R.mipmap.rain2, R.mipmap.rain3, R.mipmap.rain4}),
        毛毛雨("毛毛雨", new int[]{R.mipmap.rain, R.mipmap.rain2, R.mipmap.rain3, R.mipmap.rain4}),
        细雨("细雨", new int[]{R.mipmap.rain, R.mipmap.rain2, R.mipmap.rain3, R.mipmap.rain4}),
        冻雨("冻雨", new int[]{R.mipmap.rain, R.mipmap.rain2, R.mipmap.rain3, R.mipmap.rain4}),
        阵雨("阵雨", new int[]{R.mipmap.rain, R.mipmap.rain2, R.mipmap.rain3, R.mipmap.rain4}),
        强阵雨("强阵雨", new int[]{R.mipmap.rain3, R.mipmap.rain4}),
        极端降雨("极端降雨", new int[]{R.mipmap.rain3, R.mipmap.rain4}),
